...
import com.example.mymoviesdescription.R

class MyMoviesAdapter(private var moviesList: MutableList<MyMovie>?) :
    RecyclerView.Adapter<MyMoviesAdapter.MovieViewHolder>() {
    class MovieViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun onBind(movie: MyMovie) {
    ...
    fun appendMovies(myMovies: List<MyMovie>){
        this.moviesList!!.addAll(myMovies)
